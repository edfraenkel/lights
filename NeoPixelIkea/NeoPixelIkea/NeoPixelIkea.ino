...
Adafruit_NeoPixel stripA = Adafruit_NeoPixel(NUM_PIXELS, PINA, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel stripB = Adafruit_NeoPixel(NUM_PIXELS, PINB, NEO_GRB + NEO_KHZ800);
DeviceControl controlA(stripA, cr, "NeoIkeaA");
DeviceControl controlB(stripB, cr, "NeoIkeaB");
